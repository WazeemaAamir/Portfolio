...
<div className="w-full md:w-1/2 space-y-6">
  ...
  <p className="text-lg leading-relaxed mb-4">
    Hello, I&rsquo;m <span className="text-cyan-500 font-semibold">Wazeema Amir</span>, a passionate <span className="text-cyan-400">Frontend Developer</span> with a strong foundation in modern web technologies. 
  ...
  <p className="text-lg leading-relaxed mb-6">
    ...
    Currently, I&rsquo;m exploring <span className="text-cyan-400">Python</span> and preparing to dive into <span className="text-cyan-400">Agentic AI</span>.
  </p>
  ...
  <div className="bg-[#1f1b2f] p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-2xl">
    ...
    <ul className="list-disc pl-6 space-y-2 text-base">
      ...
      <li><strong>Master&rsquo;s in Islamic Studies & Arabic</strong> - University Graduate</li>
...
<div className="w-full md:w-1/2 space-y-6">
  ...
  <div className="bg-[#1f1b2f] p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-2xl">
    ...
    <ul className="list-disc pl-6 space-y-2 text-base">
      <li>Successfully completed GIAIC&rsquo;s intensive training program (HTML to Next.js).</li>
  ...
  <div className="bg-[#1f1b2f] p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-2xl">
    ...
    <ul className="list-disc pl-6 space-y-2 text-base">
      <li>Learning Python in GIAIC&rsquo;s 3rd Quarter curriculum.</li>
